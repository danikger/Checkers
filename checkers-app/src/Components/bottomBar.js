      ...
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between mt-2 lg:px-0 px-4">
        <div className="flex flex-1">
          <div className="flex items-center">
            <span className={`aspect-square flex rounded-full h-8 sm:h-12 bg-gray-600 items-center justify-center ${props.currentPlayer === props.playerRole ? 'ring-2 ring-yellow-500' : ''}`}>
        ...
        <button className="flex bg-gray-700 hover:bg-gray-600 text-white text-sm px-6 py-2 rounded-lg font-semibold text-center" onClick={props.onConcede}>Concede</button>
        <div className="justify-end flex flex-1">
          <div>
            <span className={`aspect-square flex rounded-full h-8 sm:h-12 border-4 sm:border-[5px] 
